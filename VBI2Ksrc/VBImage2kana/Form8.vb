...
'localization done                                                     ''+7618I~
    ...
    Private cfgWords = My.Settings.CfgFindWord                               ''~7516R~''~7517R~
    Private cfgRepWords = My.Settings.CfgRepWord                             ''~7516R~''~7517R~
    Private word = " "                                                   ''~7519R~
    Private swGetOption = False                                          ''~7521I~
    Private repWord As String                                          ''~7519I~
    Private listSearchWord = New StackList(" ", MAXWORDCTR)            ''~7517R~
    Private listRepWord = New StackList(" ", MAXWORDCTR)               ''~7517R~
    Sub New()                                                          ''~7516I~
        initDlg()                                                      ''~7516I~
    End Sub                                                            ''~7516I~
...
'        Dim title = My.Resources.MenuID_New '@@@@                     ''~7614R~
    ...
    Private Function searchWord() As Boolean                                           ''~7516I~''~7524R~
        ...
        If word.Trim().CompareTo("") = 0 Then                                 ''~7516I~
...
'                   MessageBox.Show(word, "テキストは見つかりません (" & dest & strcase & "現在位置: " & line + 1 & " 行,カラム " & posinline + 1 & ")", MessageBoxButtons.OK) ''~7516R~''~7519R~''~7521R~''~7618R~
                    MessageBox.Show(word,Rstr.MSG_ERR_FIND_NOT_FOUND & dest & strcase & Rstr.MSG_ERR_NOT_FOUND_CPOS & line + 1 & Rstr.MSG_ERR_NOT_FOUND_LINE_COL & posinline + 1 & ")", MessageBoxButtons.OK)''~7618R~
                Else                                                       ''~7519R~
'                   MessageBox.Show(word, "テキストは見つかりません (" & dest & strcase & "現在位置:不明)", MessageBoxButtons.OK) ''~7519R~''~7521R~''~7618R~
                    MessageBox.Show(word,Rstr.MSG_ERR_FIND_NOT_FOUND & dest & strcase & Rstr.MSG_ERR_NOT_FOUND_NO_CPOS, MessageBoxButtons.OK)''~7618R~
                End If                                                     ''~7519I~
            End If                                                     ''~7524I~
            TB.Focus()                                                 ''~7521I~
            Return False                                               ''~7524I~
...
'           MessageBox.Show(word, "テキストはひとつも見つかりません", MessageBoxButtons.OK) ''~7612I~''~7618R~
    ...
    Public Sub FindNext(PswUp As Boolean)    'by F3 key                ''~7519R~
        If Not swGetOption Then                                             ''~7521I~
            getOption()                                                ''~7521I~
        End If                                                         ''~7521I~
        If word.Trim().CompareTo("") = 0 Then                          ''~7519I~
