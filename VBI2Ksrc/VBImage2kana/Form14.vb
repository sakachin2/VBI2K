...
Public Class Form14                                                    ''~v076R~
    ...
    Private mruID = ClassMRU.ID_SYMBOL                                 ''~v076I~
    ...
    Private strSendID = CHAR_SENDID.ToString                           ''~v076I~
 ...
 "1", " ", "。", "句点", "Japanese period", _
 "1", " ", "、", "読点", "Japanese comma", _
 "1", " ", "・", "中点", "Punc. of middle point", _
 "1", " ", "「", "第１鍵", "1st parenthesis bent", _
 "1", " ", "」", "第１鍵", "1st parenthesis bent", _
 "1", " ", "＜", "第２鍵", "2nd parenthesis bent", _
 "1", " ", "＞", "第２鍵", "2nd parenthesis bent", _
 "1", " ", "｢｢", "ふたえ鍵(『)", "Doble parentheses bent", _
 "1", " ", "｣｣", "ふたえ鍵( 』)", "Double parentheses bent", _
 "1", " ", "｛", "第２括弧", "2nd parenthesis", _
 "1", " ", "｝", "第２括弧", "2nd parenthesis", _
 "1", " ", "((", "２重括弧(《)", "Double parentheses", _
 "1", " ", "))", "２重括弧(》)", "Double parentheses", _
 "1", " ", "［", "第１指示符(')", "1st instruction sign", _
 "1", " ", "］", "第１指示符(')", "1st instruction sign", _
 "1", " ", "[_", "第２指示符("")", "2nd instruction sign", _
 "1", " ", "_]", "第２指示符("")", "2nd instruction sign", _
 "1", " ", "[[", "第３指示符(【)", "3rd instruction sign", _
 "1", " ", "]]", "第３指示符(】)", "3rd instruction sign", _
 "1", " ", ZEN_DQ1, "外国語引用符", "Double quotation", _
 "1", " ", ZEN_DQ2, "外国語引用符", "Double quotation", _
 "1", " ", "－", "マイナス(ハイフォン)", "Minus(hiphenation)", _
 "1", " ", "－－", "ダッシュ(２マイナス)", "Dash(2 minus)", _
 "1", " ", "ーー", "棒線(２長音符)", "Horizontal bar", _
 "1", " ", "･･･", "点線(３半カナ中点)", "Dotted line", _
 "1", " ", "<--", "左向き矢印(半角)", "Left arrow", _
 "1", " ", "-->", "右向き矢印(半角)", "Right arrow", _
 "1", " ", "<-->", "両向き矢印(半角)", "Both dir. arrow", _
 "1", " ", "[==]", "空欄記号(半角)", "Sign of blank", _
 "1", " ", "~ﾟ[", "シングルクォート(" & ZEN_SQ1 & ")", "Single quotation", _
 "1", " ", "~ﾟ]", "シングルクォート(" & ZEN_SQ2 & ")", "Single quotation", _
 "1", " ", "||", "詩行符(／)", "Poem line splitter", _
 "1", " ", "~ﾟ||", "二重詩行符(／／)", "Double poem line splitter", _
 "1", " ", "~ﾟﾏﾙ", "伏せ字の○", "Consored word:○", _
 "1", " ", "~ﾟｻﾝｶ", "伏せ字の△", "Consored word:△", _
 "1", " ", "~ﾟｼｶｸ", "伏せ字の□", "Consored word:□", _
 "1", " ", "~ﾟｶｹ", "伏せ字の×", "Consored word:×", _
...
#End If
    ...
    Public Sub showForForm1(Pform As Form1)                            ''~v076I~
        ...
        dlgSymbol = Form1.MainForm.dlgSpecialKey                         ''~v076I~
    ...
    Public Sub showForForm3(Pform As Form3)                            ''~v076I~
        ...
        Form14.sharedShowDlg(swForm1)                                  ''~v076I~
    End Sub                                                            ''~v076I~
    Public Shared Sub sharedShowDlg(PswForm1 As Boolean)               ''~v076I~
        If dlgSymbol Is Nothing Then                                   ''~v076I~
            dlgSymbol = New Form14()                                   ''~v076I~
        End If                                                         ''~v076I~
        dlgSymbol.showDlg(PswForm1)                                    ''~v076I~
    End Sub                                                            ''~v076I~
    Public Function getSpecialStr(Pindex As Integer) As String         ''~v076I~
        ...
        Dim rc As String = sharedApplyWords(ch, swForm1)                  ''~v076I~
        If rc Is Nothing Then                                               ''~v076I~
            rc = ""                                                      ''~v076I~
        End If                                                         ''~v076I~
        Return rc                                                      ''~v076I~
    End Function                                                       ''~v076I~
    Public Shared Function sharedApplyWords(Pcharkey As Char, PswForm1 As Boolean) As String ''~v076I~
        ...
        If dlgSymbol Is Nothing Then                                   ''~v076I~
            dlgSymbol = New Form14()                                   ''~v076I~
            dlgSymbol.getCfg()    'setup ListData from                 ''~v076I~
        End If                                                         ''~v076I~
    ...
    Private Sub fillColumn()                                           ''~v076I~
        ...
        End If                                                         ''~v076I~
        For ii As Integer = 0 To ListData.Length / LISTDATA_COLNO - 1  ''~v076R~
            Dim pos As Integer = ii * LISTDATA_COLNO                      ''~v076I~
            Dim enable As Boolean                                      ''~v076I~
            Dim enableid As String = ListData(pos)                     ''~v076R~
            enable = IIf(enableid.CompareTo(ENABLEID_ON) = 0, True, False) ''~v076I~
    ...
    Private Function getListData() As Integer                          ''~v076I~
        ...
        For ii As Integer = 0 To rowctr - 1                            ''~v076I~
            ...
            Dim charkey As String = lst(CELLNO_CHARKEY)                ''~v079R~
            Dim phrase As String = lst(CELLNO_SYMBOL)                  ''~v079R~
            Dim del As Boolean = lst(CELLNO_DELETE)                    ''~v079R~
            Dim comment As String = lst(CELLNO_COMMENT)                ''~v079R~
            Dim commentE As String = lst(CELLNO_COMMENT_E)             ''~v079R~
            ...
            End If                                                     ''~v076I~
            Dim enable As Boolean = lst(CELLNO_ENABLE)                 ''~v079R~
            Dim enableid As String                                     ''~v076I~
            enableid = IIf(enable, ENABLEID_ON, ENABLEID_OFF)          ''~v076I~
    ...
    Private Function getDGVword(Pasckey As Integer) As String          ''~v076I~
        ...
        For ii As Integer = 0 To rowctr - 1                            ''~v076I~
            ...
            If del Then                                                ''~v076I~
                Continue For                                           ''~v076I~
            End If                                                     ''~v076I~
            Dim strkey As String = lst(CELLNO_CHARKEY)                 ''~v079R~
    ...
    Private Function chkValueValidity(Ppos As Integer, PswHandler As Boolean) As Integer ''~v076I~
        ...
        Dim charkey As String = lst(CELLNO_CHARKEY)                    ''~v079R~
        Dim phrase As String = lst(CELLNO_SYMBOL)                      ''~v079R~
        Dim cmt As String = lst(CELLNO_COMMENT)                        ''~v079R~
        Dim cmtE As String = lst(CELLNO_COMMENT_E)                     ''~v079R~
    ...
    Class DGVComparer                                                  ''~v076I~
        ...
        Public Function Compare(Prow1 As Object, Prow2 As Object) As Integer Implements System.Collections.IComparer.Compare ''~v076I~
            ...
            If col = CELLNO_ENABLE Then                                ''~v076I~
                Dim enable1 = row1.Cells(col).Value                    ''~v076I~
                Dim enable2 = row2.Cells(col).Value                    ''~v076I~
                rc = IIf(enable1 = enable2, 0, IIf(enable1, -1, 1))    ''~v076I~
            Else                                                       ''~v076I~
                Dim str1 = row1.Cells(col).Value                       ''~v076I~
                Dim str2 = row2.Cells(col).Value                       ''~v076I~
                If str1 Is Nothing Then                                ''~v076I~
                    rc = IIf(str2 Is Nothing, 0, 1)                    ''~v076I~
...
'       Else                                                           ''~v076I~''~v102R~
    ...
    Private Sub cutRow()                                               ''~v076I~
        ...
        If cpos >= 0 Then                                              ''~v076I~
            ...
            CPcutrow = cpos                                            ''~v076I~
            SB.show(SBM.MSGID.CUT, CPList(CELLNO_SYMBOL))                           ''~v076I~''~v079R~
        End If                                                         ''~v076I~
    End Sub                                                            ''~v076I~
    Private Sub copyRow()                                              ''~v076I~
        ...
        If getCurrentRowData(CPlist) >= 0 Then ''~v076I~               ''~v079R~
            ...
            SB.show(SBM.MSGID.COPY, CPList(CELLNO_SYMBOL))                          ''~v076I~''~v079R~
        End If                                                         ''~v076I~
    End Sub                                                            ''~v076I~
    Private Sub pasteRow()                                             ''~v076I~
        ...
        If CPstatus = CPSTATUS_CUT Then                                ''~v076I~
            ...
            SB.show(SBM.MSGID.CUT_PASTE, CPList(CELLNO_SYMBOL))                     ''~v076I~''~v079R~
        Else                                                           ''~v079R~
            SB.show(SBM.MSGID.COPY_PASTE, CPlist(CELLNO_SYMBOL))                    ''~v076I~''~v079R~
        End If                                                         ''~v076I~
    End Sub                                                            ''~v076I~
    ...
    Private Sub insertRow(Ppos As Integer, Plist As ArrayList, PswDelete As Boolean) ''~v079I~
        Dim swdel As Boolean = Plist(CELLNO_DELETE)                      ''~v079I~
    ...
    Private Function createArrayList(Psrc() As String, Ppos As Integer) As ArrayList ''~v079I~
        ...
        enable = IIf(enableid.CompareTo(ENABLEID_ON) = 0, True, False) ''~v079I~
    ...
    Private Sub updateRow(Prow As Integer, Plist As ArrayList, Psrc() As String, Ppos As Integer) ''~v079I~
        Dim lst As ArrayList = Plist.Clone()                       ''~v079I~
    ...
    Private Sub errNotRegisteredKey(PswForm1 As Boolean, Pasckey As Integer) ''~v076I~
        ...
        If Not PswForm1 Then                                           ''~v076I~
            If Form1.formText IsNot Nothing Then                       ''~v076I~
                Form1.formText.showStatus(msg)                         ''~v076I~
            End If                                                     ''~v076I~
        Else                                                           ''~v076I~
            Form1.MainForm.showStatus(msg)                             ''~v076I~
        End If                                                         ''~v076I~
    End Sub                                                            ''~v076I~
