...
Public Class FormatBES                                                 ''~7421I~
    ...
    Public Shared STR_REPEAT = "々ゝゞヽヾ" 'U3005,U309d,U309e,u30fd,u30fe   ''~7525I~''~7607R~
    ...
    End Function ''~7426I~
    '*********************************************************************''~7508I~
    Public Function cvHirakataAll(Pswkatakana As Boolean, Ptext As String, Ppos As Integer, ByRef Ppposnext As Integer) ''~7508I~
        posHirakataIn = Ppos
        ...
        Return txt                                                     ''~7508I~
    End Function                                                       ''~7508I~
    Public Function cvHirakataAll(Pswkatakana As Boolean, Ptext As String) ''~7428R~
    ...
    Private Function cvKataHanZen_Hira(Pch As Char, Pchnext As Char, ByRef Ppcomposit As Boolean) As Char ''~7501I~
        ...
        Return cvch                                                    ''~7501I~
    End Function                                                       ''~7501I~
    Public Function cvHirakataHankakuAll(Pswkatakana As Boolean, Ptext As String) ''~7501I~
        ...
        Return strOut                                                  ''~7501I~
    End Function                                                       ''~7501I~
    Public Function cvEisuAll(Ptext As String)                         ''~7501R~
