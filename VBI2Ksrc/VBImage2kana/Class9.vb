...
Public Class KDGV                                                      ''~v079I~
    ...
    End Sub                                                            ''~v079I~
    Public Function getRowCount()                                      ''~v079I~
        Return DGV.RowCount                                            ''~v079I~
    End Function                                                       ''~v079I~
    Public Function getColumnCount()                                   ''~v079I~
        Return DGV.ColumnCount                                         ''~v079I~
    End Function                                                       ''~v079I~
    Public Function getSelectedPos() As Integer                        ''~v079I~
        Return DGV.CurrentCell.RowIndex                                ''~v079I~
    End Function                                                       ''~v079I~
    Public Function setSelectedPos(Prow As Integer, Pcell As Integer)  ''~v079I~
    ...
    Public Function getRowDataString(Prow As Integer, Pcell As Integer, ByRef Pperr As Boolean) As String ''~v079I~
        ...
        If Pcell < 0 OrElse Pcell >= maxcell Then                               ''~v079I~
            ...
            Return str                                                 ''~v079I~
        End If                                                         ''~v079I~
        str = DGV.Rows(row).Cells(Pcell).Value                         ''~v079I~
        Pperr = False                                                    ''~v079I~
        Return str                                                     ''~v079I~
    End Function                                                       ''~v079I~
