...
Public Class DocOptions                                                ''~v030R~
    ...
    Public Shared Function showDlg(Pform3 As Form3)                    ''~v063I~
        '*** from Form3                                                    ''~v030I~
    ...
    Public Shared Function getDocOptions() As String                   ''~v072I~
        ...
        strBES99 = IIF(swBES99, "On", "Off")                               ''~v072I~
        strKatakanaDoc = IIF(swKatakanaDoc, "On", "Off")                   ''~v072I~
        strEnglishDoc = IIF(swEnglishDoc, "On", "Off")                     ''~v072I~
